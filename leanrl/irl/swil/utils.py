...
def get_random_projections(
    latent_dim: int, num_samples: int, proj_dist: str = "normal"
) -> torch.Tensor:
    """
...
class GSW:
    ...
    def get_slice(self, X: torch.Tensor, theta: Optional[torch.Tensor]) -> torch.Tensor:
    ...
    def get_powers(self, dim: int, degree: int):
        """
